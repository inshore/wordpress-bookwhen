 ...
 */
namespace _PhpScoper6af4d594edb1\Composer;

use _PhpScoper6af4d594edb1\Composer\Autoload\ClassLoader;
use _PhpScoper6af4d594edb1\Composer\Semver\VersionParser;
/**
...
class InstalledVersions
{
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('_PhpScoper6af4d594edb1\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
