 ...
 */
namespace _PhpScoper6af4d594edb1\Humbug\PhpScoper\Console;

use _PhpScoper6af4d594edb1\Fidry\Console\Application\Application;
use _PhpScoper6af4d594edb1\Fidry\Console\Input\IO;
use _PhpScoper6af4d594edb1\Humbug\PhpScoper\Autoload\ScoperAutoloadGenerator;
use _PhpScoper6af4d594edb1\Humbug\PhpScoper\Configuration\Configuration;
use _PhpScoper6af4d594edb1\Humbug\PhpScoper\Scoper\Scoper;
...
use _PhpScoper6af4d594edb1\Humbug\PhpScoper\Throwable\Exception\ParsingException;
...
use function _PhpScoper6af4d594edb1\Safe\file_get_contents;
use function _PhpScoper6af4d594edb1\Safe\fileperms;
...
final class ConsoleScoper
{
    ...
    private static function getFiles(Configuration $config, string $outputDir) : array
    {
        ...
        $commonDirectoryPath = Path::getLongestCommonBasePath(...array_map(static fn(string $path) => Path::getDirectory($path), array_keys($filesWithContent)), ...array_map(static fn(string $path) => Path::getDirectory($path), array_keys($excludedFilesWithContents)));
        Assert::notNull($commonDirectoryPath);
        $mapFiles = static fn(array $inputFileTuple) => [$inputFileTuple[0], $inputFileTuple[1], $outputDir . str_replace($commonDirectoryPath, '', $inputFileTuple[0])];
