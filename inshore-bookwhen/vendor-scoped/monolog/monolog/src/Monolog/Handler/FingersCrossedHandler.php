...
use Closure;
use _PhpScoper6af4d594edb1\Monolog\Handler\FingersCrossed\ErrorLevelActivationStrategy;
use _PhpScoper6af4d594edb1\Monolog\Handler\FingersCrossed\ActivationStrategyInterface;
use _PhpScoper6af4d594edb1\Monolog\Level;
use _PhpScoper6af4d594edb1\Monolog\Logger;
use _PhpScoper6af4d594edb1\Monolog\ResettableInterface;
...
class FingersCrossedHandler extends Handler implements ProcessableHandlerInterface, ResettableInterface, FormattableHandlerInterface
{
     ...
     */
    public function __construct(Closure|HandlerInterface $handler, int|string|Level|ActivationStrategyInterface $activationStrategy = null, int $bufferSize = 0, bool $bubble = \true, bool $stopBuffering = \true, int|string|Level|null $passthruLevel = null)
    {
