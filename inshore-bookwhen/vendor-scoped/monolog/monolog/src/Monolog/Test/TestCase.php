 ...
 */
namespace _PhpScoper6af4d594edb1\Monolog\Test;
...
use _PhpScoper6af4d594edb1\Monolog\DateTimeImmutable;
 ...
 */
class TestCase extends \_PhpScoper6af4d594edb1\PHPUnit\Framework\TestCase
{
     ...
     */
    protected function getRecord(int|string|Level $level = Level::Warning, string|\Stringable $message = 'test', array $context = [], string $channel = 'test', \DateTimeImmutable $datetime = new DateTimeImmutable(\true), array $extra = []) : LogRecord
    {
    ...
    protected function getIdentityFormatter() : FormatterInterface
    {
        ...
        $formatter->expects(self::any())->method('format')->will(self::returnCallback(function ($record) {
