...
use _PhpScoper6af4d594edb1\StubTests\Parsers\ExpectedFunctionArgumentsInfo;
use _PhpScoper6af4d594edb1\StubTests\Parsers\MetaExpectedArgumentsCollector;
...
class StubsMetaExpectedArgumentsTest extends AbstractBaseStubsTestCase
{
    ...
    {
        return self::flatten(array_map(fn(PHPClass $class) => array_map(fn(PHPMethod $method) => self::getClassMemberFqn($class->name, $method->name), $class->methods), $stubs->getClasses()));
    }
    /**
     * @throws Exception
     */
