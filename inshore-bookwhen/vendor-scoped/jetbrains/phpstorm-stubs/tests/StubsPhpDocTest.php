...
use _PhpScoper6af4d594edb1\phpDocumentor\Reflection\DocBlock\Tags\Reference\Url;
...
use _PhpScoper6af4d594edb1\StubTests\Model\BasePHPClass;
use _PhpScoper6af4d594edb1\StubTests\Model\BasePHPElement;
use _PhpScoper6af4d594edb1\StubTests\Model\PHPConst;
use _PhpScoper6af4d594edb1\StubTests\Model\PHPDocElement;
...
class StubsPhpDocTest extends AbstractBaseStubsTestCase
{
    ...
    private static function checkContainsOnlyValidTags(BasePHPElement $element, string $elementName) : void
    {
        $VALID_TAGS = [
            ...
            'deprecated',
            'example',
            //temporary addition due to the number of existing cases
            'inheritdoc',
            'inheritDoc',
            'internal',
            'implements',
