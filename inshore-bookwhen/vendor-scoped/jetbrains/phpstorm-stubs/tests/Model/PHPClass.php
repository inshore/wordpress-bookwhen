...
use Exception;
use _PhpScoper6af4d594edb1\phpDocumentor\Reflection\DocBlock\Tags\PropertyRead;
...
class PHPClass extends BasePHPClass
{
    ...
    public function getProperty($propertyName)
    {
        $properties = \array_filter($this->properties, function (PHPProperty $property) use($propertyName) {
            return $property->name === $propertyName && $property->duplicateOtherElement === \false && BasePHPElement::entitySuitsCurrentPhpVersion($property);
        });
        if (empty($properties)) {
