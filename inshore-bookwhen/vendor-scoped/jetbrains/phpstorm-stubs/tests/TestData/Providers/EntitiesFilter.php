...
class EntitiesFilter
{
     ...
     */
    public static function getFilteredFunctions(PHPInterface|PHPClass $class = null, bool $shouldSuitCurrentPhpVersion = \true) : array
    {
        if ($class === null) {
        ...
        $resultArray = [];
        $allFunctions = \array_filter($allFunctions, fn($function) => !$shouldSuitCurrentPhpVersion || BasePHPElement::entitySuitsCurrentPhpVersion($function));
