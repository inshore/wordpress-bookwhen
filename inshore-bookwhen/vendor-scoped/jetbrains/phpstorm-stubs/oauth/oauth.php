 ...
 * The OAuth extension provides a simple interface to interact with data providers using the OAuth HTTP specification to protect private resources.
 */
\class_alias('_PhpScoper6af4d594edb1\\OAuth', 'OAuth', \false);
...
\class_alias('_PhpScoper6af4d594edb1\\OAuthException', 'OAuthException', \false);
/**
...
class OAuthProvider
{
     ...
     * @return bool
     */
    public final function addRequiredParameter($req_params)
    {
    }
    /**
     * @return void
     ...
     * @return string
     */
    public static final function generateToken($size, $strong = \false)
    {
    }
    /**
     ...
     * @return bool
     */
    public final function removeRequiredParameter($req_params)
    {
    }
    /**
     ...
     * @return string
     */
    public static final function reportProblem($oauthexception, $send_headers = \true)
    {
    }
    /**
     ...
     * @return bool
     */
    public final function setParam($param_key, $param_val = null)
    {
    }
    /**
     * @param string $path
     * @return bool
     */
    public final function setRequestTokenPath($path)
    {
    }
    /**
     * @param callable $callback_function
 ...
 * Manages an OAuth provider class.
 */
\class_alias('_PhpScoper6af4d594edb1\\OAuthProvider', 'OAuthProvider', \false);
