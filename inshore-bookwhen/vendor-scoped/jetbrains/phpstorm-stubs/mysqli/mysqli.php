 ...
 * mysqli_sql_exception
 */
\class_alias('_PhpScoper6af4d594edb1\\mysqli_sql_exception', 'mysqli_sql_exception', \false);
/**
 * MySQLi Driver.
 ...
 * @link https://php.net/manual/en/class.mysqli-driver.php
 */
\class_alias('_PhpScoper6af4d594edb1\\mysqli_driver', 'mysqli_driver', \false);
/**
...
class mysqli
{
     ...
     */
    #[TentativeType]
    public function begin_transaction(#[LanguageLevelTypeAware(['8.0' => 'int'], default: '')] $flags = 0, #[LanguageLevelTypeAware(['8.0' => 'string|null'], default: '')] $name = null) : bool
    {
    }
    /**
 ...
 * @link https://php.net/manual/en/class.mysqli.php
 */
\class_alias('_PhpScoper6af4d594edb1\\mysqli', 'mysqli', \false);
/**
 ...
 * @link https://php.net/manual/en/class.mysqli-warning.php
 */
\class_alias('_PhpScoper6af4d594edb1\\mysqli_warning', 'mysqli_warning', \false);
/**
...
class mysqli_result implements \IteratorAggregate
{
     ...
     */
    public function __construct(#[PhpStormStubsElementAvailable(from: '8.0')] \mysqli $mysql, #[PhpStormStubsElementAvailable(from: '8.0')] int $result_mode = \MYSQLI_STORE_RESULT)
    {
    }
    /**
 ...
 * @link https://php.net/manual/en/class.mysqli-result.php
 */
\class_alias('_PhpScoper6af4d594edb1\\mysqli_result', 'mysqli_result', \false);
/**
 ...
 * @link https://php.net/manual/en/class.mysqli-stmt.php
 */
\class_alias('_PhpScoper6af4d594edb1\\mysqli_stmt', 'mysqli_stmt', \false);
/**
 ...
 */
function mysqli_fetch_all(\mysqli_result $result, #[PhpStormStubsElementAvailable(from: '7.0')] int $mode = \MYSQLI_NUM) : array
{
}
/**
 * Fetch the next row of a result set as an associative, a numeric array, or both
 ...
 */
function mysqli_multi_query(\mysqli $mysql, #[PhpStormStubsElementAvailable(from: '5.3', to: '7.0')] string $query, #[PhpStormStubsElementAvailable(from: '7.1', to: '7.4')] string $query = null, #[PhpStormStubsElementAvailable(from: '8.0')] string $query) : bool
{
}
/**
 * Prepare next result from multi_query
 ...
 */
function mysqli_query(\mysqli $mysql, string $query, #[PhpStormStubsElementAvailable(from: '7.1')] int $result_mode = \MYSQLI_STORE_RESULT) : \mysqli_result|bool
{
}
/**
 * Opens a connection to a mysql server
 ...
 * @return bool
 */
function mysqli_real_query(\mysqli $mysql, #[PhpStormStubsElementAvailable(from: '5.3', to: '7.0')] string $query, #[PhpStormStubsElementAvailable(from: '7.1', to: '7.4')] string $query = null, #[PhpStormStubsElementAvailable(from: '8.0')] string $query) : bool
{
}
/**
 * Get result from async query
 ...
 * @return bool true on success or false on failure.
 */
function mysqli_stmt_bind_param(\mysqli_stmt $statement, string $types, #[PhpStormStubsElementAvailable(from: '5.3', to: '7.4')] mixed &$vars, mixed &...$vars) : bool
{
}
/**
 * Binds variables to a prepared statement for result storage
 ...
 * @return bool
 */
function mysqli_stmt_bind_result(\mysqli_stmt $statement, #[PhpStormStubsElementAvailable(from: '5.3', to: '7.4')] mixed &$vars, mixed &...$vars) : bool
{
}
/**
 * Fetch results from a prepared statement into the bound variables
 ...
 * @return string
 */
function mysqli_escape_string(\mysqli $mysql, string $string, #[PhpStormStubsElementAvailable(from: '7.1', to: '7.4')] $resultmode = null) : string
{
}
/**
 ...
 * @return bool
 */
function mysqli_set_opt(#[PhpStormStubsElementAvailable(from: '8.0')] \mysqli $mysql, #[PhpStormStubsElementAvailable(from: '8.0')] int $option, #[PhpStormStubsElementAvailable(from: '8.0')] $value) : bool
{
}
/**
 * <p>
