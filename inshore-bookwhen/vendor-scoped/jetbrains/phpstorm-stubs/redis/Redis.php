...
class Redis
{
    ...
    public function open($host, $port = 6379, $timeout = 0, $persistent_id = null, $retry_interval = 0, $read_timeout = 0, $context = null)
    {
    }
    /**
     ...
     * </pre>
     */
    public function pconnect($host, $port = 6379, $timeout = 0, $persistent_id = null, $retry_interval = 0, $read_timeout = 0, $context = null)
    {
    }
    /**
     * @param string $host
    ...
    public function popen($host, $port = 6379, $timeout = 0, $persistent_id = null, $retry_interval = 0, $read_timeout = 0, $context = null)
    {
    }
    /**
 ...
 * @link   https://github.com/ukko/phpredis-phpdoc
 */
\class_alias('_PhpScoper6af4d594edb1\\Redis', 'Redis', \false);
class RedisException extends \Exception
{
}
\class_alias('_PhpScoper6af4d594edb1\\RedisException', 'RedisException', \false);
