...
// Start of ming v.
\class_alias('_PhpScoper6af4d594edb1\\SWFShape', 'SWFShape', \false);
class SWFFill
{
    public function __construct()
    {
...
\class_alias('_PhpScoper6af4d594edb1\\SWFFill', 'SWFFill', \false);
class SWFGradient
{
    public function __construct()
    {
...
\class_alias('_PhpScoper6af4d594edb1\\SWFGradient', 'SWFGradient', \false);
class SWFBitmap
{
    public function __construct()
    {
...
\class_alias('_PhpScoper6af4d594edb1\\SWFBitmap', 'SWFBitmap', \false);
class SWFText
{
    public function __construct()
    {
...
\class_alias('_PhpScoper6af4d594edb1\\SWFText', 'SWFText', \false);
class SWFTextField
{
    public function __construct()
    {
...
\class_alias('_PhpScoper6af4d594edb1\\SWFTextField', 'SWFTextField', \false);
class SWFFont
{
    public function __construct()
    {
...
\class_alias('_PhpScoper6af4d594edb1\\SWFFont', 'SWFFont', \false);
...
\class_alias('_PhpScoper6af4d594edb1\\SWFDisplayItem', 'SWFDisplayItem', \false);
class SWFMovie
{
    public function __construct()
    {
...
\class_alias('_PhpScoper6af4d594edb1\\SWFMovie', 'SWFMovie', \false);
class SWFButton
{
    public function __construct()
    {
...
\class_alias('_PhpScoper6af4d594edb1\\SWFButton', 'SWFButton', \false);
class SWFAction
{
    public function __construct()
    {
...
\class_alias('_PhpScoper6af4d594edb1\\SWFAction', 'SWFAction', \false);
class SWFMorph
{
    public function __construct()
    {
...
\class_alias('_PhpScoper6af4d594edb1\\SWFMorph', 'SWFMorph', \false);
class SWFSprite
{
    public function __construct()
    {
...
\class_alias('_PhpScoper6af4d594edb1\\SWFSprite', 'SWFSprite', \false);
class SWFSound
{
    public function __construct()
    {
...
\class_alias('_PhpScoper6af4d594edb1\\SWFSound', 'SWFSound', \false);
class SWFFontChar
{
    public function addChars()
    {
...
\class_alias('_PhpScoper6af4d594edb1\\SWFFontChar', 'SWFFontChar', \false);
...
\class_alias('_PhpScoper6af4d594edb1\\SWFSoundInstance', 'SWFSoundInstance', \false);
...
\class_alias('_PhpScoper6af4d594edb1\\SWFVideoStream', 'SWFVideoStream', \false);
/**
 * Set cubic threshold
