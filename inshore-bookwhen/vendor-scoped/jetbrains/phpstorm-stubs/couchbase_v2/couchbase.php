 ...
 * @package Couchbase
 */
namespace _PhpScoper6af4d594edb1\Couchbase;

/** If igbinary extension was not found during build phase this constant will store 0 */
\define("_PhpScoper6af4d594edb1\\Couchbase\\HAVE_IGBINARY", 1);
/** If libz headers was not found during build phase this constant will store 0 */
\define("_PhpScoper6af4d594edb1\\Couchbase\\HAVE_ZLIB", 1);
/** Encodes documents as JSON objects (see INI section for details)
 * @see \Couchbase\basicEncoderV1
 */
\define("_PhpScoper6af4d594edb1\\Couchbase\\ENCODER_FORMAT_JSON", 0);
/** Encodes documents using pecl/igbinary encoder (see INI section for details)
 * @see \Couchbase\basicEncoderV1
 */
\define("_PhpScoper6af4d594edb1\\Couchbase\\ENCODER_FORMAT_IGBINARY", 1);
/** Encodes documents using PHP serialize() (see INI section for details)
 * @see \Couchbase\basicEncoderV1
 */
\define("_PhpScoper6af4d594edb1\\Couchbase\\ENCODER_FORMAT_PHP", 2);
/** Do not use compression for the documents
 * @see \Couchbase\basicEncoderV1
 */
\define("_PhpScoper6af4d594edb1\\Couchbase\\ENCODER_COMPRESSION_NONE", 0);
/** Use zlib compressor for the documents
 * @see \Couchbase\basicEncoderV1
 */
\define("_PhpScoper6af4d594edb1\\Couchbase\\ENCODER_COMPRESSION_ZLIB", 1);
/** Use FastLZ compressor for the documents
 * @see \Couchbase\basicEncoderV1
 */
\define("_PhpScoper6af4d594edb1\\Couchbase\\ENCODER_COMPRESSION_FASTLZ", 2);
/**
