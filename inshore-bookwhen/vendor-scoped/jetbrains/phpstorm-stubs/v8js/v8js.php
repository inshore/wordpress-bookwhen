...
\class_alias('_PhpScoper6af4d594edb1\\V8Js', 'V8Js', \false);
final class V8JsScriptException extends \Exception
{
    /**
     * @return string
     */
    public final function getJsFileName()
    {
    }
    /**
     * @return int
     */
    public final function getJsLineNumber()
    {
    }
    /**
     * @return int
     */
    public final function getJsStartColumn()
    {
    }
    /**
     * @return int
     */
    public final function getJsEndColumn()
    {
    }
    /**
     * @return string
     */
    public final function getJsSourceLine()
    {
    }
    /**
     * @return string
     */
    public final function getJsTrace()
    {
    }
}
\class_alias('_PhpScoper6af4d594edb1\\V8JsScriptException', 'V8JsScriptException', \false);
final class V8JsTimeLimitException extends \Exception
{
}
\class_alias('_PhpScoper6af4d594edb1\\V8JsTimeLimitException', 'V8JsTimeLimitException', \false);
final class V8JsMemoryLimitException extends \Exception
{
}
\class_alias('_PhpScoper6af4d594edb1\\V8JsMemoryLimitException', 'V8JsMemoryLimitException', \false);
