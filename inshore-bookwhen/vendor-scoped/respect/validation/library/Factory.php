...
namespace _PhpScoper6af4d594edb1\Respect\Validation;

use ReflectionClass;
use ReflectionException;
use ReflectionObject;
use _PhpScoper6af4d594edb1\Respect\Validation\Exceptions\ComponentException;
use _PhpScoper6af4d594edb1\Respect\Validation\Exceptions\InvalidClassException;
use _PhpScoper6af4d594edb1\Respect\Validation\Exceptions\ValidationException;
use _PhpScoper6af4d594edb1\Respect\Validation\Message\Formatter;
use _PhpScoper6af4d594edb1\Respect\Validation\Message\ParameterStringifier;
use _PhpScoper6af4d594edb1\Respect\Validation\Message\Stringifier\KeepOriginalStringName;
...
final class Factory
{
     ...
     * @var string[]
     */
    private $rulesNamespaces = ['_PhpScoper6af4d594edb1\\Respect\\Validation\\Rules'];
    /**
     * @var string[]
     */
    private $exceptionsNamespaces = ['_PhpScoper6af4d594edb1\\Respect\\Validation\\Exceptions'];
    /**
     * @var callable
     */
