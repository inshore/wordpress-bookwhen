...
namespace _PhpScoper6af4d594edb1\Respect\Validation\Helpers;
...
trait CanValidateDateTime
{
    ...
    private function isDateTime(string $format, string $value) : bool
    {
        ...
        if ($this->isDateFormat($format)) {
            $formattedDate = DateTime::createFromFormat($format, $value, new DateTimeZone(date_default_timezone_get()));
