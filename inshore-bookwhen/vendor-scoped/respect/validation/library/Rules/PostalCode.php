...
final class PostalCode extends AbstractEnvelope
{
    ...
    public function __construct(string $countryCode, bool $formatted = \false)
    {
        ...
        parent::__construct(new Regex(self::POSTAL_CODES_EXTRA[$countryCode][$formatted ? 0 : 1] ?? self::POSTAL_CODES[$countryCode][$formatted ? 0 : 1] ?? self::DEFAULT_PATTERN), ['countryCode' => $countryCode]);
    }
}
