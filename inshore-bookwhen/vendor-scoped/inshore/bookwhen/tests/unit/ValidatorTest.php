...
class ValidatorTest extends TestCase
{
    ...
    {
        return ['attachmentIdNull' => [null, 'attachment'], 'attachmentIdEmptyString' => ['', 'attachment'], 'attachmentIdObject' => [new \stdClass(), 'attachment'], 'attachmentIdNonAlphaNumeric' => ['*&^GLJjklihl', 'attachment'], 'attachmentIdShortAlphaNumeric' => ['asdfjkld', 'attachment'], 'attachmentIdLongAlphaNumeric' => ['asdfjksdffdsdfld', 'attachment'], 'emptyString' => ['', null], 'object' => [new \stdClass(), null], 'null' => [null, null], 'longAlphaNumeric' => ['asdfjksdffdsdfld', null], 'nonAlphaNumeric' => ['*&^GLJjklihl', null], 'shortAlphaNumeric' => ['asdfjkld', null], 'classPassIdNull' => [null, 'classPass'], 'classPassIdEmptyString' => ['', 'classPass'], 'classPassIdObject' => [new \stdClass(), 'classPass'], 'eventIdNull' => [null, 'eventId'], 'locationIdNull' => [null, 'location'], 'locationEmptyString' => ['', 'location'], 'locationIdObject' => [new \stdClass(), 'location'], 'locationIdNonAlphaNumeric' => ['*&^GLJjklihl', 'location'], 'locationIdShortAlphaNumeric' => ['asdfjkld', 'location'], 'locationIdLongAlphaNumeric' => ['asdfjksdffdsdfld', 'location']];
    }
    public static function provideInvalidTags() : array
    {
        return ['null' => [null], 'emptyString' => [''], 'object' => [new \stdClass()], 'nonAlphanumeric' => ['akrwejh[?fs83z420qrzc8397r4']];
    }
    ...
    {
        return ['datePast' => ['20191230'], 'datePresent' => [\date('Ymd')], 'dateFuture' => ['20291230']];
    }
    public static function provideValidFroms() : array
    {
        return ['fromFutureToNull' => ['20291230', null], 'fromPastToNull' => ['20191230', null], 'fromPastToFuture' => ['20191230', '20290809'], 'fromPastToPast' => ['20191230', '20200101'], 'fromPastToPresent' => ['20191230', \date('Ymd')], 'fromPresentToNull' => [\date('Ymd'), null]];
    }
    public static function provideValidIds() : array
    {
        return ['attachmentId' => ['9v06h1cbv0en', 'attachment'], 'classPassId' => ['cp-vk3x1brhpsbf', 'classPass'], 'default' => ['9v06h1cbv0en', null], 'eventId' => ['ev-sf8b-20200813100000', 'event'], 'locationId' => ['sjm7pskr31t3', 'location'], 'ticketId' => ['ti-sboe-20200320100000-tk1m', 'ticket']];
    }
    public static function provideValidTags() : array
    {
        return ['alphanumericMixedcase' => ['a1D3'], 'alphanumericLowercase' => ['a1C3'], 'alphanumericUppercase' => ['A1C3'], 'lettersMixedcase' => ['aBcD'], 'lettersLowercase' => ['abcd'], 'lettersUppercase' => ['ABCD'], 'numeric' => ['1323']];
    }
    public static function provideValidTokens() : array
    {
        return ['ours' => ['6v47r0jdz3r2ao3yc8f1vyx2kjry']];
    }
    public static function provideValidTos() : array
    {
        return ['toFutureFromNull' => ['20291230', null], 'toPastFromNull' => ['20191230', null], 'toPastFromPast' => ['20200809', '20191230'], 'toPastFromPast' => ['20200101', '20191230'], 'toPresentFromNull' => [\date('Ymd'), null], 'toPresentFromPast' => [\date('Ymd'), '20191230']];
    }
    public static function provideValidTitle() : array
    {
        return ['validTitle' => ['Yoga Level 2']];
    }
    ...
    {
        return ['validFileType' => ['jpg'], 'validFileType' => ['jpeg'], 'validFileType' => ['gif'], 'validFileType' => ['png'], 'validFileType' => ['JPG'], 'validFileType' => ['JPEG'], 'validFileType' => ['GIF'], 'validFileType' => ['PNG']];
    }
    ...
    {
        return ['validFileName' => ['Yoga Time']];
    }
    ...
    {
        return ['validInclude' => [\true], 'validInclude' => [\false]];
    }
