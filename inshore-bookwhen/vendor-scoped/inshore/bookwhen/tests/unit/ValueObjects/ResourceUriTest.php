...
final class ResourceUriTest extends TestCase
{
    ...
    {
        return ['null/null' => [null, null], 'emptyString/null' => ['', null], 'object/null' => [new \stdClass(), null], 'resource/null' => ['resource', null], 'resource/emptyString' => ['resource', ''], 'resource/object' => ['resource', new \stdClass()]];
    }
    /**
     * 
     */
    ...
    {
        return ['resource/id' => ['resource', 'resource-id-1']];
    }
    /**
...
\class_alias('_PhpScoper6af4d594edb1\\ResourceUriTest', 'ResourceUriTest', \false);
