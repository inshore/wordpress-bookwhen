...
namespace _PhpScoper6af4d594edb1\tests\unit\Responses\Tickets;
...
final class RetrieveResponseTest extends TestCase
{
    ...
    {
        $attributes = ['attributes' => ['available' => \true, 'available_from' => 'Available from goes here', 'available_to' => 'Available to goes here', 'built_basket_url' => 'Built basket url goes here', 'built_basket_iframe_url' => 'Built basket iframe url goes here', 'course_ticket' => \false, 'details' => 'Details go here', 'group_ticket' => \true, 'group_min' => 1, 'group_max' => 10, 'number_issued' => 10, 'number_taken' => 5, 'title' => 'Title goes here'], 'id' => 'ti-s4bs-20230501080000-tp9b'];
