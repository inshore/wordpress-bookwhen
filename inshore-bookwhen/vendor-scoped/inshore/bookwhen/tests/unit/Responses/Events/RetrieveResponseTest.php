...
namespace _PhpScoper6af4d594edb1\tests\unit\Responses\Events;
...
final class RetrieveResponseTest extends TestCase
{
    ...
    {
        $attributes = ['attributes' => ['all_day' => \true, 'attendee_count' => 7, 'attendee_limit' => 10, 'details' => 'Details goes here', 'end_at' => 'End at goes here', 'max_tickets_per_booking' => 20, 'start_at' => 'Start at goes here', 'title' => 'Title goes here', 'waiting_list' => \true], 'relationships' => ['attachments' => ['data' => [['id' => '3wepl3we3kq9']]], 'location' => ['data' => ['id' => 'sjm7pskr31t3']], 'tickets' => ['data' => [['id' => 'ti-s4bs-20230501080000-tp9b']]]], 'id' => '9v06h1cbv0en'];
