...
namespace _PhpScoper6af4d594edb1\tests\unit\Responses\Locations;
...
final class RetrieveResponseTest extends TestCase
{
    ...
    {
        $attributes = ['attributes' => ['additional_info' => 'Additional info goes here', 'address_text' => 'Address text goes here', 'latitude' => 49.1649391, 'longitude' => -2.5272508, 'map_url' => 'https://cdn.bookwhen.com/blank_map.png?v=20230422143101', 'zoom' => 10], 'id' => 'w0uh48ad3fm2'];
    ...
    {
        $attributes = ['attributes' => ['additional_info' => null, 'address_text' => null, 'latitude' => null, 'longitude' => null, 'map_url' => null, 'zoom' => null], 'id' => 'w0uh48ad3fm2'];
        $location = RetrieveResponse::from($attributes);
