...
namespace _PhpScoper6af4d594edb1\tests\unit\Responses\Attachments;
...
final class RetrieveResponseTest extends TestCase
{
    ...
    {
        $attributes = ['attributes' => ['content_type' => 'Content type goes here', 'file_name' => 'File name goes here', 'file_size_bytes' => 'File size bytes goes here', 'file_size_text' => 'File size text goes here', 'file_type' => 'File type goes here', 'file_url' => 'File url goes here', 'title' => 'Title goes here'], 'id' => '9v06h1cbv0en'];
    ...
    {
        $attributes = ['attributes' => ['content_type' => null, 'file_name' => null, 'file_size_bytes' => null, 'file_size_text' => null, 'file_type' => null, 'file_url' => null, 'title' => null], 'id' => '9v06h1cbv0en'];
        $attachment = RetrieveResponse::from($attributes);
