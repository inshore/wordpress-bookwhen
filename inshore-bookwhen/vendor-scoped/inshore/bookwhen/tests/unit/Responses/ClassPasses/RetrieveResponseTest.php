...
namespace _PhpScoper6af4d594edb1\tests\unit\Responses\ClassPasses;
...
final class RetrieveResponseTest extends TestCase
{
    ...
    {
        $attributes = ['attributes' => ['details' => 'Details goes here', 'number_available' => 20, 'title' => 'Title goes here', 'usage_allowance' => 10, 'usage_type' => 'personal', 'use_restricted_for_days' => 60], 'id' => 'cp-vk3x1brhpsbf'];
    ...
    {
        $attributes = ['attributes' => ['details' => null, 'number_available' => null, 'title' => null, 'usage_allowance' => null, 'usage_type' => null, 'use_restricted_for_days' => null], 'id' => 'cp-vk3x1brhpsbf'];
        $classPass = RetrieveResponse::from($attributes);
