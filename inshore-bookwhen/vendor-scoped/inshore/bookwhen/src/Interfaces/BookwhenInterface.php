...
use _PhpScoper6af4d594edb1\InShore\Bookwhen\Domain\Ticket;
...
interface BookwhenInterface
{
     ...
     * @throws RestException if an error occurs during API interation.
     */
    public function attachments(null|string $title, null|string $fileName, null|string $fileType) : array;
    /**
     ...
     */
    public function classPasses(null|string $title, null|string $detail, null|string $usageType, null|string $cost, null|string $usageAllowance, null|string $useRestrictedForDays);
    /**
     ...
     */
    public function events(string $calendar, string $entry, array $location, array $tags, array $title, array $detail, string $from, string $to, bool $includeLocation, bool $includeAttachments, bool $includeTickets, bool $includeTicketsEvents, bool $includeTicketsClassPasses) : array;
    /**
     ...
     */
    public function locations(string $addressText, string $additionalInfo) : array;
    /**
