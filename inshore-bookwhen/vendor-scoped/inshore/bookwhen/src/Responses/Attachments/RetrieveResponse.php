...
namespace _PhpScoper6af4d594edb1\InShore\Bookwhen\Responses\Attachments;
...
final class RetrieveResponse implements ResponseContract
{
    ...
    {
        return new self($attributes['attributes']['content_type'] ?? null, $attributes['attributes']['file_name'] ?? null, $attributes['attributes']['file_size_bytes'] ?? null, $attributes['attributes']['file_size_text'] ?? null, $attributes['attributes']['file_type'] ?? null, $attributes['attributes']['file_url'] ?? null, $attributes['id'], $attributes['attributes']['title'] ?? null);
    }
}
