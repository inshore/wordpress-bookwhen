...
namespace _PhpScoper6af4d594edb1\InShore\Bookwhen\Responses\Tickets;
...
final class RetrieveResponse implements ResponseContract
{
    ...
    public static function from(array $attributes, $included = []) : self
    {
        ...
        return new self($attributes['attributes']['available'] ?? null, $attributes['attributes']['available_from'] ?? null, $attributes['attributes']['available_to'] ?? null, $attributes['attributes']['built_basket_url'] ?? null, $attributes['attributes']['built_basket_iframe_url'] ?? null, $cost, $attributes['attributes']['course_ticket'] ?? null, $attributes['attributes']['details'] ?? null, $attributes['attributes']['group_ticket'] ?? null, $attributes['attributes']['group_min'] ?? null, $attributes['attributes']['group_max'] ?? null, $attributes['id'], $attributes['attributes']['number_issued'] ?? null, $attributes['attributes']['number_taken'] ?? null, $attributes['attributes']['title'] ?? null);
    }
}
