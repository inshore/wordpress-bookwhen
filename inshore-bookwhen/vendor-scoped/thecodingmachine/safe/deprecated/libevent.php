...
use _PhpScoper6af4d594edb1\Safe\Exceptions\LibeventException;
/**
...
{
    \error_clear_last();
    $result = \_PhpScoper6af4d594edb1\event_base_reinit($event_base);
    if ($result === \false) {
        throw LibeventException::createFromPhpError();
    }
}
...
{
    \error_clear_last();
    $result = \_PhpScoper6af4d594edb1\event_priority_set($event, $priority);
    if ($result === \false) {
        throw LibeventException::createFromPhpError();
    }
}
