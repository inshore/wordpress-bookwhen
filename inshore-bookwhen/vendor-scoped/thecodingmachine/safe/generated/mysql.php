...
use _PhpScoper6af4d594edb1\Safe\Exceptions\MysqlException;
/**
...
{
    \error_clear_last();
    $safeResult = \_PhpScoper6af4d594edb1\mysql_create_db($database_name, $link_identifier);
    if ($safeResult === \false) {
        throw MysqlException::createFromPhpError();
    }
}
...
{
    \error_clear_last();
    $safeResult = \_PhpScoper6af4d594edb1\mysql_drop_db($database_name, $link_identifier);
    if ($safeResult === \false) {
        throw MysqlException::createFromPhpError();
    }
}
