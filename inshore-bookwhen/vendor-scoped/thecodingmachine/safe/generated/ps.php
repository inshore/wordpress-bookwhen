...
use _PhpScoper6af4d594edb1\Safe\Exceptions\PsException;
/**
...
{
    \error_clear_last();
    $safeResult = \_PhpScoper6af4d594edb1\ps_add_launchlink($psdoc, $llx, $lly, $urx, $ury, $filename);
    if ($safeResult === \false) {
...
{
    \error_clear_last();
    $safeResult = \_PhpScoper6af4d594edb1\ps_add_locallink($psdoc, $llx, $lly, $urx, $ury, $page, $dest);
    if ($safeResult === \false) {
        throw PsException::createFromPhpError();
    }
}
...
{
    \error_clear_last();
    $safeResult = \_PhpScoper6af4d594edb1\ps_add_note($psdoc, $llx, $lly, $urx, $ury, $contents, $title, $icon, $open);
    if ($safeResult === \false) {
        throw PsException::createFromPhpError();
    }
}
...
{
    \error_clear_last();
    $safeResult = \_PhpScoper6af4d594edb1\ps_add_pdflink($psdoc, $llx, $lly, $urx, $ury, $filename, $page, $dest);
    if ($safeResult === \false) {
        throw PsException::createFromPhpError();
    }
}
...
{
    \error_clear_last();
    $safeResult = \_PhpScoper6af4d594edb1\ps_add_weblink($psdoc, $llx, $lly, $urx, $ury, $url);
    if ($safeResult === \false) {
        throw PsException::createFromPhpError();
    }
}
...
{
    \error_clear_last();
    $safeResult = \_PhpScoper6af4d594edb1\ps_arc($psdoc, $x, $y, $radius, $alpha, $beta);
    if ($safeResult === \false) {
        throw PsException::createFromPhpError();
    }
}
...
{
    \error_clear_last();
    $safeResult = \_PhpScoper6af4d594edb1\ps_arcn($psdoc, $x, $y, $radius, $alpha, $beta);
    if ($safeResult === \false) {
        throw PsException::createFromPhpError();
    }
}
...
{
    \error_clear_last();
    $safeResult = \_PhpScoper6af4d594edb1\ps_begin_page($psdoc, $width, $height);
    if ($safeResult === \false) {
        throw PsException::createFromPhpError();
    }
}
...
{
    \error_clear_last();
    $safeResult = \_PhpScoper6af4d594edb1\ps_begin_pattern($psdoc, $width, $height, $xstep, $ystep, $painttype);
    if ($safeResult === \false) {
        throw PsException::createFromPhpError();
    }
    return $safeResult;
...
{
    \error_clear_last();
    $safeResult = \_PhpScoper6af4d594edb1\ps_begin_template($psdoc, $width, $height);
    if ($safeResult === \false) {
        throw PsException::createFromPhpError();
    }
    return $safeResult;
...
{
    \error_clear_last();
    $safeResult = \_PhpScoper6af4d594edb1\ps_circle($psdoc, $x, $y, $radius);
    if ($safeResult === \false) {
        throw PsException::createFromPhpError();
    }
}
...
{
    \error_clear_last();
    $safeResult = \_PhpScoper6af4d594edb1\ps_clip($psdoc);
    if ($safeResult === \false) {
        throw PsException::createFromPhpError();
    }
}
...
{
    \error_clear_last();
    $safeResult = \_PhpScoper6af4d594edb1\ps_close_image($psdoc, $imageid);
    if ($safeResult === \false) {
        throw PsException::createFromPhpError();
    }
}
...
{
    \error_clear_last();
    $safeResult = \_PhpScoper6af4d594edb1\ps_close($psdoc);
    if ($safeResult === \false) {
        throw PsException::createFromPhpError();
    }
}
...
{
    \error_clear_last();
    $safeResult = \_PhpScoper6af4d594edb1\ps_closepath_stroke($psdoc);
    if ($safeResult === \false) {
        throw PsException::createFromPhpError();
    }
}
...
{
    \error_clear_last();
    $safeResult = \_PhpScoper6af4d594edb1\ps_closepath($psdoc);
    if ($safeResult === \false) {
        throw PsException::createFromPhpError();
    }
}
...
{
    \error_clear_last();
    $safeResult = \_PhpScoper6af4d594edb1\ps_continue_text($psdoc, $text);
    if ($safeResult === \false) {
        throw PsException::createFromPhpError();
    }
}
...
{
    \error_clear_last();
    $safeResult = \_PhpScoper6af4d594edb1\ps_curveto($psdoc, $x1, $y1, $x2, $y2, $x3, $y3);
    if ($safeResult === \false) {
        throw PsException::createFromPhpError();
    }
}
...
{
    \error_clear_last();
    $safeResult = \_PhpScoper6af4d594edb1\ps_delete($psdoc);
    if ($safeResult === \false) {
        throw PsException::createFromPhpError();
    }
}
...
{
    \error_clear_last();
    $safeResult = \_PhpScoper6af4d594edb1\ps_end_page($psdoc);
    if ($safeResult === \false) {
        throw PsException::createFromPhpError();
    }
}
...
{
    \error_clear_last();
    $safeResult = \_PhpScoper6af4d594edb1\ps_end_pattern($psdoc);
    if ($safeResult === \false) {
        throw PsException::createFromPhpError();
    }
}
...
{
    \error_clear_last();
    $safeResult = \_PhpScoper6af4d594edb1\ps_end_template($psdoc);
    if ($safeResult === \false) {
        throw PsException::createFromPhpError();
    }
}
...
{
    \error_clear_last();
    $safeResult = \_PhpScoper6af4d594edb1\ps_fill_stroke($psdoc);
    if ($safeResult === \false) {
        throw PsException::createFromPhpError();
    }
}
...
{
    \error_clear_last();
    $safeResult = \_PhpScoper6af4d594edb1\ps_fill($psdoc);
    if ($safeResult === \false) {
        throw PsException::createFromPhpError();
    }
}
...
function ps_get_parameter($psdoc, string $name, float $modifier = null) : string
{
    \error_clear_last();
    if ($modifier !== null) {
        $safeResult = \_PhpScoper6af4d594edb1\ps_get_parameter($psdoc, $name, $modifier);
    } else {
        $safeResult = \_PhpScoper6af4d594edb1\ps_get_parameter($psdoc, $name);
    }
    if ($safeResult === \false) {
        throw PsException::createFromPhpError();
    }
...
{
    \error_clear_last();
    $safeResult = \_PhpScoper6af4d594edb1\ps_hyphenate($psdoc, $text);
    if ($safeResult === \false) {
        throw PsException::createFromPhpError();
    }
    return $safeResult;
...
{
    \error_clear_last();
    $safeResult = \_PhpScoper6af4d594edb1\ps_include_file($psdoc, $file);
    if ($safeResult === \false) {
        throw PsException::createFromPhpError();
    }
}
...
{
    \error_clear_last();
    $safeResult = \_PhpScoper6af4d594edb1\ps_lineto($psdoc, $x, $y);
    if ($safeResult === \false) {
        throw PsException::createFromPhpError();
    }
}
...
{
    \error_clear_last();
    $safeResult = \_PhpScoper6af4d594edb1\ps_moveto($psdoc, $x, $y);
    if ($safeResult === \false) {
        throw PsException::createFromPhpError();
    }
}
...
{
    \error_clear_last();
    $safeResult = \_PhpScoper6af4d594edb1\ps_new();
    if ($safeResult === \false) {
        throw PsException::createFromPhpError();
    }
    return $safeResult;
...
function ps_open_file($psdoc, string $filename = null) : void
{
    \error_clear_last();
    if ($filename !== null) {
        $safeResult = \_PhpScoper6af4d594edb1\ps_open_file($psdoc, $filename);
    } else {
        $safeResult = \_PhpScoper6af4d594edb1\ps_open_file($psdoc);
    }
    if ($safeResult === \false) {
        throw PsException::createFromPhpError();
    }
...
{
    \error_clear_last();
    $safeResult = \_PhpScoper6af4d594edb1\ps_place_image($psdoc, $imageid, $x, $y, $scale);
    if ($safeResult === \false) {
        throw PsException::createFromPhpError();
    }
}
...
{
    \error_clear_last();
    $safeResult = \_PhpScoper6af4d594edb1\ps_rect($psdoc, $x, $y, $width, $height);
    if ($safeResult === \false) {
        throw PsException::createFromPhpError();
    }
}
...
{
    \error_clear_last();
    $safeResult = \_PhpScoper6af4d594edb1\ps_restore($psdoc);
    if ($safeResult === \false) {
        throw PsException::createFromPhpError();
    }
}
...
{
    \error_clear_last();
    $safeResult = \_PhpScoper6af4d594edb1\ps_rotate($psdoc, $rot);
    if ($safeResult === \false) {
        throw PsException::createFromPhpError();
    }
}
...
{
    \error_clear_last();
    $safeResult = \_PhpScoper6af4d594edb1\ps_save($psdoc);
    if ($safeResult === \false) {
        throw PsException::createFromPhpError();
    }
}
...
{
    \error_clear_last();
    $safeResult = \_PhpScoper6af4d594edb1\ps_scale($psdoc, $x, $y);
    if ($safeResult === \false) {
        throw PsException::createFromPhpError();
    }
}
...
{
    \error_clear_last();
    $safeResult = \_PhpScoper6af4d594edb1\ps_set_border_color($psdoc, $red, $green, $blue);
    if ($safeResult === \false) {
        throw PsException::createFromPhpError();
    }
}
...
{
    \error_clear_last();
    $safeResult = \_PhpScoper6af4d594edb1\ps_set_border_dash($psdoc, $black, $white);
    if ($safeResult === \false) {
        throw PsException::createFromPhpError();
    }
}
...
{
    \error_clear_last();
    $safeResult = \_PhpScoper6af4d594edb1\ps_set_border_style($psdoc, $style, $width);
    if ($safeResult === \false) {
        throw PsException::createFromPhpError();
    }
}
...
{
    \error_clear_last();
    $safeResult = \_PhpScoper6af4d594edb1\ps_set_info($p, $key, $val);
    if ($safeResult === \false) {
        throw PsException::createFromPhpError();
    }
}
...
{
    \error_clear_last();
    $safeResult = \_PhpScoper6af4d594edb1\ps_set_parameter($psdoc, $name, $value);
    if ($safeResult === \false) {
        throw PsException::createFromPhpError();
    }
}
...
{
    \error_clear_last();
    $safeResult = \_PhpScoper6af4d594edb1\ps_set_text_pos($psdoc, $x, $y);
    if ($safeResult === \false) {
        throw PsException::createFromPhpError();
    }
}
...
{
    \error_clear_last();
    $safeResult = \_PhpScoper6af4d594edb1\ps_set_value($psdoc, $name, $value);
    if ($safeResult === \false) {
        throw PsException::createFromPhpError();
    }
}
...
{
    \error_clear_last();
    $safeResult = \_PhpScoper6af4d594edb1\ps_setcolor($psdoc, $type, $colorspace, $c1, $c2, $c3, $c4);
    if ($safeResult === \false) {
        throw PsException::createFromPhpError();
    }
}
...
{
    \error_clear_last();
    $safeResult = \_PhpScoper6af4d594edb1\ps_setdash($psdoc, $on, $off);
    if ($safeResult === \false) {
        throw PsException::createFromPhpError();
    }
}
...
{
    \error_clear_last();
    $safeResult = \_PhpScoper6af4d594edb1\ps_setflat($psdoc, $value);
    if ($safeResult === \false) {
        throw PsException::createFromPhpError();
    }
}
...
{
    \error_clear_last();
    $safeResult = \_PhpScoper6af4d594edb1\ps_setfont($psdoc, $fontid, $size);
    if ($safeResult === \false) {
        throw PsException::createFromPhpError();
    }
}
...
{
    \error_clear_last();
    $safeResult = \_PhpScoper6af4d594edb1\ps_setgray($psdoc, $gray);
    if ($safeResult === \false) {
        throw PsException::createFromPhpError();
    }
}
...
{
    \error_clear_last();
    $safeResult = \_PhpScoper6af4d594edb1\ps_setlinecap($psdoc, $type);
    if ($safeResult === \false) {
        throw PsException::createFromPhpError();
    }
}
...
{
    \error_clear_last();
    $safeResult = \_PhpScoper6af4d594edb1\ps_setlinejoin($psdoc, $type);
    if ($safeResult === \false) {
        throw PsException::createFromPhpError();
    }
}
...
{
    \error_clear_last();
    $safeResult = \_PhpScoper6af4d594edb1\ps_setlinewidth($psdoc, $width);
    if ($safeResult === \false) {
        throw PsException::createFromPhpError();
    }
}
...
{
    \error_clear_last();
    $safeResult = \_PhpScoper6af4d594edb1\ps_setmiterlimit($psdoc, $value);
    if ($safeResult === \false) {
        throw PsException::createFromPhpError();
    }
}
...
{
    \error_clear_last();
    $safeResult = \_PhpScoper6af4d594edb1\ps_setoverprintmode($psdoc, $mode);
    if ($safeResult === \false) {
        throw PsException::createFromPhpError();
    }
}
...
{
    \error_clear_last();
    $safeResult = \_PhpScoper6af4d594edb1\ps_setpolydash($psdoc, $arr);
    if ($safeResult === \false) {
        throw PsException::createFromPhpError();
    }
}
...
{
    \error_clear_last();
    $safeResult = \_PhpScoper6af4d594edb1\ps_shading_pattern($psdoc, $shadingid, $optlist);
    if ($safeResult === \false) {
        throw PsException::createFromPhpError();
    }
    return $safeResult;
...
{
    \error_clear_last();
    $safeResult = \_PhpScoper6af4d594edb1\ps_shading($psdoc, $type, $x0, $y0, $x1, $y1, $c1, $c2, $c3, $c4, $optlist);
    if ($safeResult === \false) {
        throw PsException::createFromPhpError();
    }
    return $safeResult;
...
{
    \error_clear_last();
    $safeResult = \_PhpScoper6af4d594edb1\ps_shfill($psdoc, $shadingid);
    if ($safeResult === \false) {
        throw PsException::createFromPhpError();
    }
}
...
{
    \error_clear_last();
    $safeResult = \_PhpScoper6af4d594edb1\ps_show_xy($psdoc, $text, $x, $y);
    if ($safeResult === \false) {
        throw PsException::createFromPhpError();
    }
}
...
{
    \error_clear_last();
    $safeResult = \_PhpScoper6af4d594edb1\ps_show_xy2($psdoc, $text, $len, $xcoor, $ycoor);
    if ($safeResult === \false) {
        throw PsException::createFromPhpError();
    }
}
...
{
    \error_clear_last();
    $safeResult = \_PhpScoper6af4d594edb1\ps_show($psdoc, $text);
    if ($safeResult === \false) {
        throw PsException::createFromPhpError();
    }
}
...
{
    \error_clear_last();
    $safeResult = \_PhpScoper6af4d594edb1\ps_show2($psdoc, $text, $len);
    if ($safeResult === \false) {
        throw PsException::createFromPhpError();
    }
}
...
{
    \error_clear_last();
    $safeResult = \_PhpScoper6af4d594edb1\ps_stroke($psdoc);
    if ($safeResult === \false) {
        throw PsException::createFromPhpError();
    }
}
...
{
    \error_clear_last();
    $safeResult = \_PhpScoper6af4d594edb1\ps_symbol($psdoc, $ord);
    if ($safeResult === \false) {
        throw PsException::createFromPhpError();
    }
}
...
{
    \error_clear_last();
    $safeResult = \_PhpScoper6af4d594edb1\ps_translate($psdoc, $x, $y);
    if ($safeResult === \false) {
        throw PsException::createFromPhpError();
    }
}
