...
use _PhpScoper6af4d594edb1\Safe\Exceptions\SsdeepException;
/**
...
{
    \error_clear_last();
    $safeResult = \_PhpScoper6af4d594edb1\ssdeep_fuzzy_compare($signature1, $signature2);
    if ($safeResult === \false) {
...
{
    \error_clear_last();
    $safeResult = \_PhpScoper6af4d594edb1\ssdeep_fuzzy_hash_filename($file_name);
    if ($safeResult === \false) {
        throw SsdeepException::createFromPhpError();
    }
    return $safeResult;
...
{
    \error_clear_last();
    $safeResult = \_PhpScoper6af4d594edb1\ssdeep_fuzzy_hash($to_hash);
    if ($safeResult === \false) {
        throw SsdeepException::createFromPhpError();
    }
    return $safeResult;
