...
use _PhpScoper6af4d594edb1\Safe\Exceptions\YazException;
/**
...
{
    \error_clear_last();
    $safeResult = \_PhpScoper6af4d594edb1\yaz_ccl_parse($id, $query, $result);
    if ($safeResult === \false) {
...
{
    \error_clear_last();
    $safeResult = \_PhpScoper6af4d594edb1\yaz_close($id);
    if ($safeResult === \false) {
        throw YazException::createFromPhpError();
    }
}
...
function yaz_connect(string $zurl, $options = null)
{
    \error_clear_last();
    if ($options !== null) {
        $safeResult = \_PhpScoper6af4d594edb1\yaz_connect($zurl, $options);
    } else {
        $safeResult = \_PhpScoper6af4d594edb1\yaz_connect($zurl);
    }
    if ($safeResult === \false) {
        throw YazException::createFromPhpError();
    }
...
{
    \error_clear_last();
    $safeResult = \_PhpScoper6af4d594edb1\yaz_database($id, $databases);
    if ($safeResult === \false) {
        throw YazException::createFromPhpError();
    }
}
...
{
    \error_clear_last();
    $safeResult = \_PhpScoper6af4d594edb1\yaz_element($id, $elementset);
    if ($safeResult === \false) {
        throw YazException::createFromPhpError();
    }
}
...
{
    \error_clear_last();
    $safeResult = \_PhpScoper6af4d594edb1\yaz_present($id);
    if ($safeResult === \false) {
        throw YazException::createFromPhpError();
    }
}
...
{
    \error_clear_last();
    $safeResult = \_PhpScoper6af4d594edb1\yaz_search($id, $type, $query);
    if ($safeResult === \false) {
        throw YazException::createFromPhpError();
    }
}
...
{
    \error_clear_last();
    $safeResult = \_PhpScoper6af4d594edb1\yaz_wait($options);
    if ($safeResult === \false) {
        throw YazException::createFromPhpError();
    }
    return $safeResult;
