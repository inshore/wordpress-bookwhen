...
use _PhpScoper6af4d594edb1\GuzzleHttp\Cookie\CookieJar;
use _PhpScoper6af4d594edb1\GuzzleHttp\Exception\GuzzleException;
use _PhpScoper6af4d594edb1\GuzzleHttp\Exception\InvalidArgumentException;
 ...
 * @final
 */
class Client implements ClientInterface, \_PhpScoper6af4d594edb1\Psr\Http\Client\ClientInterface
{
    use ClientTrait;
    /**
