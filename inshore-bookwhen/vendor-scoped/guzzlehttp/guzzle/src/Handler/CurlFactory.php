...
namespace _PhpScoper6af4d594edb1\GuzzleHttp\Handler;

use _PhpScoper6af4d594edb1\GuzzleHttp\Exception\ConnectException;
use _PhpScoper6af4d594edb1\GuzzleHttp\Exception\RequestException;
use _PhpScoper6af4d594edb1\GuzzleHttp\Promise as P;
use _PhpScoper6af4d594edb1\GuzzleHttp\Promise\FulfilledPromise;
use _PhpScoper6af4d594edb1\GuzzleHttp\Promise\PromiseInterface;
use _PhpScoper6af4d594edb1\GuzzleHttp\Psr7\LazyOpenStream;
use _PhpScoper6af4d594edb1\GuzzleHttp\TransferStats;
use _PhpScoper6af4d594edb1\GuzzleHttp\Utils;
...
class CurlFactory implements CurlFactoryInterface
{
    ...
    private function applyHandlerOptions(EasyHandle $easy, array &$conf) : void
    {
        ...
        if (!isset($options['sink'])) {
            ...
            $options['sink'] = \_PhpScoper6af4d594edb1\GuzzleHttp\Psr7\Utils::tryFopen('php://temp', 'w+');
        }
        $sink = $options['sink'];
        if (!\is_string($sink)) {
            $sink = \_PhpScoper6af4d594edb1\GuzzleHttp\Psr7\Utils::streamFor($sink);
