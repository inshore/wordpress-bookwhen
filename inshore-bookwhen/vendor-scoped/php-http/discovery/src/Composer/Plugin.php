...
namespace _PhpScoper6af4d594edb1\Http\Discovery\Composer;

use _PhpScoper6af4d594edb1\Composer\Composer;
use _PhpScoper6af4d594edb1\Composer\DependencyResolver\Pool;
use _PhpScoper6af4d594edb1\Composer\EventDispatcher\EventSubscriberInterface;
use _PhpScoper6af4d594edb1\Composer\Factory;
use _PhpScoper6af4d594edb1\Composer\Installer;
use _PhpScoper6af4d594edb1\Composer\IO\IOInterface;
use _PhpScoper6af4d594edb1\Composer\Json\JsonFile;
use _PhpScoper6af4d594edb1\Composer\Json\JsonManipulator;
use _PhpScoper6af4d594edb1\Composer\Package\Locker;
use _PhpScoper6af4d594edb1\Composer\Package\Version\VersionParser;
use _PhpScoper6af4d594edb1\Composer\Package\Version\VersionSelector;
use _PhpScoper6af4d594edb1\Composer\Plugin\PluginInterface;
use _PhpScoper6af4d594edb1\Composer\Repository\InstalledRepositoryInterface;
use _PhpScoper6af4d594edb1\Composer\Repository\RepositorySet;
use _PhpScoper6af4d594edb1\Composer\Script\Event;
use _PhpScoper6af4d594edb1\Composer\Script\ScriptEvents;
use _PhpScoper6af4d594edb1\Composer\Util\Filesystem;
...
class Plugin implements PluginInterface, EventSubscriberInterface
{
    ...
    private const INTERFACE_MAP = ['php-http/async-client-implementation' => ['_PhpScoper6af4d594edb1\\Http\\Client\\HttpAsyncClient'], 'php-http/client-implementation' => ['_PhpScoper6af4d594edb1\\Http\\Client\\HttpClient'], 'psr/http-client-implementation' => ['_PhpScoper6af4d594edb1\\Psr\\Http\\Client\\ClientInterface'], 'psr/http-factory-implementation' => ['_PhpScoper6af4d594edb1\\Psr\\Http\\Message\\RequestFactoryInterface', '_PhpScoper6af4d594edb1\\Psr\\Http\\Message\\ResponseFactoryInterface', '_PhpScoper6af4d594edb1\\Psr\\Http\\Message\\ServerRequestFactoryInterface', '_PhpScoper6af4d594edb1\\Psr\\Http\\Message\\StreamFactoryInterface', '_PhpScoper6af4d594edb1\\Psr\\Http\\Message\\UploadedFileFactoryInterface', '_PhpScoper6af4d594edb1\\Psr\\Http\\Message\\UriFactoryInterface']];
    ...
    public function getMissingRequires(InstalledRepositoryInterface $repo, array $requires, bool $isProject, array $pinnedAbstractions) : array
    {
        ...
        if (ClassDiscovery::safeClassExists(\_PhpScoper6af4d594edb1\Phalcon\Http\Message\RequestFactory::class, \false)) {
