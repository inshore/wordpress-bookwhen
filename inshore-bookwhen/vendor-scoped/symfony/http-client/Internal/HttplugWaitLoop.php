...
use _PhpScoper6af4d594edb1\Http\Promise\Promise;
use _PhpScoper6af4d594edb1\Psr\Http\Message\RequestInterface as Psr7RequestInterface;
...
final class HttplugWaitLoop
{
    ...
    public function wait(?ResponseInterface $pendingResponse, float $maxDuration = null, float $idleTimeout = null) : int
    {
        ...
        $guzzleQueue = \_PhpScoper6af4d594edb1\GuzzleHttp\Promise\Utils::queue();
