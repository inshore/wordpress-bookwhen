 ...
 */
namespace _PhpScoper6af4d594edb1\Symfony\Component\String\Inflector;
...
final class FrenchInflector implements InflectorInterface
{
    ...
    private const PLURALIZE_REGEXP = [
        ...
        // French titles
        ['/^(mon|ma)(sieur|dame|demoiselle|seigneur)$/', '_PhpScoper6af4d594edb1\\mes\\2s'],
        ['/^(Mon|Ma)(sieur|dame|demoiselle|seigneur)$/', '_PhpScoper6af4d594edb1\\Mes\\2s'],
    ];
    /**
    ...
    private const SINGULARIZE_REGEXP = [
        ...
        // French titles
        ['/^mes(dame|demoiselle)s$/', '_PhpScoper6af4d594edb1\\ma\\1'],
        ['/^Mes(dame|demoiselle)s$/', '_PhpScoper6af4d594edb1\\Ma\\1'],
        ['/^mes(sieur|seigneur)s$/', '_PhpScoper6af4d594edb1\\mon\\1'],
        ['/^Mes(sieur|seigneur)s$/', '_PhpScoper6af4d594edb1\\Mon\\1'],
        // Default rule
        ['/s$/i', ''],
    ];
